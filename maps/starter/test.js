...
async function getFormResponses() {
  ...
  WA.ui.displayActionMessage({
    message: `reply：${rows[rows.length-1].join(" | ")}`,
    callback: () => {WA.chat.sendChatMessage("confirmed", "trigger message logic")}
  });
}
...
// WA.room.setTiles([
//           { x: currPosX+1, y: currPosY-1, tile: 2006, layer: "entity" },
//           { x: currPosX+1, y: currPosY, tile: 2007, layer: "entity" }
//         ]);
//         prevPosX1 = currPosX+1;
//         prevPosY1 = currPosY-1;
//         prevPosX2 = currPosX+1;
//         prevPosY2 = currPosY;
//         }